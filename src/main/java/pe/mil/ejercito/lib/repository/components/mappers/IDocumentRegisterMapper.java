...
public interface IDocumentRegisterMapper {
    ...
    @Mapping(target = "epStatisticsAeEntities", ignore = true)
    @Mapping(target = "epStatisticsCoadneEntities", ignore = true)
    @Mapping(target = "epStatisticsDeEntities", ignore = true)
    @Mapping(target = "epStatisticsDiciteceEntities", ignore = true)
    @Mapping(target = "epStatisticsDieEntities", ignore = true)
    @Mapping(target = "epStatisticsDilogeEntities", ignore = true)
    @Mapping(target = "epStatisticsDinveEntities", ignore = true)
    @Mapping(target = "epStatisticsDiplaneEntities", ignore = true)
    @Mapping(target = "epStatisticsDisaleEntities", ignore = true)
    @Mapping(target = "epStatisticsOajeEntities", ignore = true)
    @Mapping(target = "epStatisticsOeeEntities", ignore = true)
    @Mapping(target = "epStatisticsDiradneEntities", ignore = true)
